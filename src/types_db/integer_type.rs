...
impl Type for IntegerType {
    ...
    fn compare_equals(&self, other: &Value) -> CmpBool {
        match other.get_val() {
            ...
            Val::BigInt(r) => CmpBool::from(0 == *r as i32),
    ...
    fn multiply(&self, other: &Value) -> Result<Value, String> {
        match other.get_val() {
            Val::Integer(r) => Ok(Value::new(0)),
            Val::TinyInt(r) => Ok(Value::new(0)),
            Val::SmallInt(r) => Ok(Value::new(0)),
            Val::BigInt(r) => Ok(Value::new(0)),
            Val::Decimal(r) => Ok(Value::new(0)),
            Val::Null => Ok(Value::new(Val::Null)),
    ...
    fn min(&self, other: &Value) -> Value {
        match other.get_val() {
            ...
            Val::BigInt(r) => Value::new(0.min(*r as i32)),
            _ => Value::new(Val::Null),
        }
    }
    ...
    fn max(&self, other: &Value) -> Value {
        match other.get_val() {
            ...
            Val::BigInt(r) => Value::new(0.max(*r as i32)),
            _ => Value::new(Val::Null),
        }
    }
