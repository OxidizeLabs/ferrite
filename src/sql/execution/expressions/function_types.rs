...
pub fn get_function_type(name: &str) -> FunctionType {
    match name.to_uppercase().as_str() {
        ...
        "ABS" | "ROUND" | "CEIL" | "FLOOR" => 
            FunctionType::Scalar(ScalarFunctionType::Numeric),
        
        // Scalar DateTime Functions
        "NOW" | "EXTRACT" => 
            FunctionType::Scalar(ScalarFunctionType::DateTime),
        
        // Cast Functions
        "CAST" | "CONVERT" =>
            FunctionType::Scalar(ScalarFunctionType::Cast),
        ...
        "STDDEV" | "VARIANCE" => 
            FunctionType::Aggregate(AggregateFunctionType::Statistical),
        
        // Window Functions
        "ROW_NUMBER" | "RANK" | "DENSE_RANK" => 
            FunctionType::Window(WindowFunctionType::Ranking),
