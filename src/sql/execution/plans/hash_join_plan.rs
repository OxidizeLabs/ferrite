...
mod tests {
    ...
    fn test_hash_join_creation() {
        ...
        let join_node = HashJoinNode::new(
            left_schema.clone(),
            right_schema.clone(),
            left_expr.clone(),
    ...
    fn test_hash_join_display() {
        ...
        let left_key = Arc::new(Expression::ColumnRef(ColumnRefExpression::new(
            0,
            0,
            Column::new("hash_key", TypeId::Integer),
            vec![],
        )));
        ...
        // Test basic display
        assert_eq!(join_node.to_string(), "→ HashJoin");
        ...
        assert!(detailed.contains("Hash Keys:"));
    }
    ...
    fn test_plan_type() {
        ...
        assert_eq!(join_node.get_type(), PlanType::HashJoin);
    }
}
