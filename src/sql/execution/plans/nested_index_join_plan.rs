...
mod tests {
    ...
    #[test]
    fn test_nested_index_join_creation() {
        ...
        let join_node = NestedIndexJoinNode::new(
            left_schema.clone(),
            right_schema.clone(),
            left_expr.clone(),
    ...
    #[test]
    fn test_nested_index_join_getters() {
        let left_schema = create_test_schema("dept");
        let right_schema = create_test_schema("emp");
    ...
    #[test]
    fn test_nested_index_join_display() {
        let left_schema = create_test_schema("dept");
        let right_schema = create_test_schema("emp");
        ...
        // Test basic display
        assert_eq!(join_node.to_string(), "→ NestedIndexJoin");
    ...
    fn test_plan_type() {
        ...
        assert_eq!(join_node.get_type(), PlanType::NestedIndexJoin);
    }
}
