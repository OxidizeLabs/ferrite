                ...
                Ok(Expression::TypedString(TypedStringExpression::new(
                    ...
                    Column::new(
                        ...
                        match data_type {
                            ...
                            DataType::Table(_) => TypeId::Invalid,
                            DataType::Character(_) => TypeId::Char,
                            DataType::Char(_) => TypeId::Char,
                            DataType::CharacterVarying(_) => TypeId::VarChar,
                            DataType::CharVarying(_) => TypeId::VarChar,
                            DataType::Varchar(_) => TypeId::VarChar,
                            DataType::Nvarchar(_) => TypeId::VarChar,
                            DataType::Uuid => TypeId::VarChar,
                            DataType::CharacterLargeObject(_) => TypeId::VarChar,
                            DataType::CharLargeObject(_) => TypeId::VarChar,
                            DataType::Clob(_) => TypeId::VarChar,
                            DataType::Binary(_) => TypeId::Binary,
                            DataType::Varbinary(_) => TypeId::Binary,
                            DataType::Blob(_) => TypeId::Binary,
                            DataType::TinyBlob => TypeId::Binary,
                            DataType::MediumBlob => TypeId::Binary,
                            DataType::LongBlob => TypeId::Binary,
                            DataType::Bytes(_) => TypeId::Binary,
                            DataType::Numeric(_) => TypeId::Decimal,
                            DataType::Decimal(_) => TypeId::Decimal,
                            DataType::BigNumeric(_) => TypeId::Decimal,
                            DataType::BigDecimal(_) => TypeId::Decimal,
                            DataType::Dec(_) => TypeId::Decimal,
                            DataType::Float(_) => TypeId::Decimal,
                            DataType::TinyInt(_) => TypeId::TinyInt,
                            DataType::TinyIntUnsigned(_) => TypeId::TinyInt,
                            DataType::UTinyInt => TypeId::TinyInt,
                            DataType::Int2(_) => TypeId::SmallInt,
                            DataType::Int2Unsigned(_) => TypeId::SmallInt,
                            DataType::SmallInt(_) => TypeId::SmallInt,
                            DataType::SmallIntUnsigned(_) => TypeId::SmallInt,
                            DataType::USmallInt => TypeId::SmallInt,
                            DataType::MediumInt(_) => TypeId::Integer,
                            DataType::MediumIntUnsigned(_) => TypeId::Integer,
                            DataType::Int(_) => TypeId::Integer,
                            DataType::Int4(_) => TypeId::Integer,
                            DataType::Int8(_) => TypeId::BigInt,
                            DataType::Int16 => TypeId::SmallInt,
                            DataType::Int32 => TypeId::Integer,
                            DataType::Int64 => TypeId::BigInt,
                            DataType::Int128 => TypeId::BigInt,
                            DataType::Int256 => TypeId::BigInt,
                            DataType::Integer(_) => TypeId::Integer,
                            DataType::IntUnsigned(_) => TypeId::Integer,
                            DataType::Int4Unsigned(_) => TypeId::Integer,
                            DataType::IntegerUnsigned(_) => TypeId::Integer,
                            DataType::HugeInt => TypeId::BigInt,
                            DataType::UHugeInt => TypeId::BigInt,
                            DataType::UInt8 => TypeId::TinyInt,
                            DataType::UInt16 => TypeId::SmallInt,
                            DataType::UInt32 => TypeId::Integer,
                            DataType::UInt64 => TypeId::BigInt,
                            DataType::UInt128 => TypeId::BigInt,
                            DataType::UInt256 => TypeId::BigInt,
                            DataType::BigInt(_) => TypeId::BigInt,
                            DataType::BigIntUnsigned(_) => TypeId::BigInt,
                            DataType::UBigInt => TypeId::BigInt,
                            DataType::Int8Unsigned(_) => TypeId::BigInt,
                            DataType::Signed => TypeId::Integer,
                            DataType::SignedInteger => TypeId::Integer,
                            DataType::Unsigned => TypeId::Integer,
                            DataType::UnsignedInteger => TypeId::Integer,
                            DataType::Float4 => TypeId::Decimal,
                            DataType::Float32 => TypeId::Decimal,
                            DataType::Float64 => TypeId::Decimal,
                            DataType::Real => TypeId::Decimal,
                            DataType::Float8 => TypeId::Decimal,
                            DataType::Double(_) => TypeId::Decimal,
                            DataType::DoublePrecision => TypeId::Decimal,
                            DataType::Bool => TypeId::Boolean,
                            DataType::Boolean => TypeId::Boolean,
                            ...
                            DataType::Text => TypeId::VarChar,
                            DataType::TinyText => TypeId::VarChar,
                            DataType::MediumText => TypeId::VarChar,
                            DataType::LongText => TypeId::VarChar,
                            DataType::String(_) => TypeId::VarChar,
                            DataType::FixedString(_) => TypeId::Char,
                            DataType::Bytea => TypeId::Binary,
                            DataType::Bit(_) => TypeId::Binary,
                            DataType::BitVarying(_) => TypeId::Binary,
                            DataType::VarBit(_) => TypeId::Binary,
                            DataType::Custom(_, _) => TypeId::Invalid,
                            DataType::Array(_) => TypeId::Vector,
                            DataType::Map(_, _) => TypeId::Struct,
                            DataType::Tuple(_) => TypeId::Vector,
                            DataType::Nested(_) => TypeId::Struct,
                            DataType::Enum(_, _) => TypeId::VarChar,
                            DataType::Set(_) => TypeId::Vector,
                            DataType::Struct(_, _) => TypeId::Struct,
                            DataType::Union(_) => TypeId::Invalid,
                            DataType::Nullable(_) => TypeId::Invalid,
                            DataType::LowCardinality(_) => TypeId::Invalid,
                            DataType::Unspecified => TypeId::Invalid,
                            ...
                            match subscript {
                                        ...
                                        match &index {
                                            ...
                                            Expr::Identifier(ident) => {
                                                ...
                                                expr = Expression::MapAccess(
                                                    MapAccessExpression::new(
                                                        Arc::new(expr),
                                                        vec![MapAccessKey::String(
                                                            ident.value.clone(),
                                                        )],
                                                        Column::new(
                                                            &format!("field_{}", ident.value),
                                                            TypeId::Invalid,
                                                        ),
                                                    ),
                                                );
                                ...
                                SQLSubscript::Slice {
                                    ...
                                    let lower_expr = lower_bound.as_ref().map(|e| {
                                        Arc::new(self.parse_expression(e, schema).unwrap_or_else(
                                            |_| {
...
mod tests {
    ...
    async fn test_parse_join_operators() {
        ...
        let using_cols = vec![ObjectName(vec![ObjectNamePart::Identifier(Ident::new(
            "id",
        ))])];
