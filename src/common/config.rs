...
pub const BUCKET_SIZE: usize = 50; // size of extendable hash bucket
...
pub type TxnId = i32; // transaction id type
pub type Lsn = i32; // log sequence number type
pub type SlotOffset = usize; // slot offset type
pub type Oid = u16; // object id type
pub type TableOidT = i32;
pub type ColumnOidT = i32;
pub type IndexOidT = i32;
pub type TimeStampOidT = i32;
