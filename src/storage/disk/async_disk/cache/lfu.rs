    ...
    mod performance {
        ...
        mod insertion_performance {
            ...
            fn test_batch_insertion_performance() {
                ...
                let ops_per_second =
                    throughput_cache_size as f64 / throughput_duration.as_secs_f64();
        ...
        mod eviction_performance {
            ...
            fn test_pop_lfu_performance() {
                ...
                // Check consistency
                let avg_duration =
                    pop_durations.iter().sum::<Duration>() / pop_durations.len() as u32;
    ...
    mod concurrency {
        ...
        mod thread_safety {
            ...
            fn test_concurrent_insertions() {
                let cache: ThreadSafeLFUCache<String, i32> =
                    Arc::new(Mutex::new(LFUCache::new(1000)));
                let num_threads = 8;
            ...
            fn test_concurrent_gets() {
                let cache: ThreadSafeLFUCache<String, i32> =
                    Arc::new(Mutex::new(LFUCache::new(500)));
            ...
            fn test_concurrent_frequency_operations() {
                let cache: ThreadSafeLFUCache<String, i32> =
                    Arc::new(Mutex::new(LFUCache::new(100)));
            ...
            fn test_concurrent_lfu_operations() {
                let cache: ThreadSafeLFUCache<String, i32> =
                    Arc::new(Mutex::new(LFUCache::new(200)));
                ...
                let mut popped_keys: std::collections::HashSet<String> =
            ...
            fn test_mixed_concurrent_operations() {
                let cache: ThreadSafeLFUCache<String, i32> =
                    Arc::new(Mutex::new(LFUCache::new(300)));
                let num_threads = 8;
        ...
        mod stress_testing {
            ...
            fn test_high_contention_scenario() {
                ...
                let cache: ThreadSafeLFUCache<String, i32> =
                    Arc::new(Mutex::new(LFUCache::new(50)));
                let num_threads = 20;
                ...
                let conflict_rate =
                    total_conflicts as f64 / (total_successes + total_conflicts) as f64;
                assert!(
                    conflict_rate < 0.5,
            ...
            fn test_long_running_stability() {
                ...
                let cache: ThreadSafeLFUCache<String, i64> =
                    Arc::new(Mutex::new(LFUCache::new(200)));
            ...
            fn test_burst_load_handling() {
                ...
                let cache: ThreadSafeLFUCache<String, i32> =
                    Arc::new(Mutex::new(LFUCache::new(150)));
                            ...
                            match operation {
                                ...
                                3 => {
                                    ...
                                    if i < 100 {
                                        ...
                                        let stress_key =
                                            format!("stress_{}_{}", thread_id, (i / 2) % 50);
