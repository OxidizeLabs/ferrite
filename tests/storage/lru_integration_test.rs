// use std::sync::Arc;
// use crate::storage::disk::async_disk::cache::lru::{LRUCore, ConcurrentLRUCache};
// use crate::storage::disk::async_disk::cache::cache_traits::{CoreCache, MutableCache, LRUCacheTrait};
...
//         // - Key 1 was accessed (most recent)
//         // - Key 2 was evicted
//         // - Key 3 was removed
//         // - Key 4 was just inserted
//         // So we should have keys 1 and 4 remaining, with 4 being LRU (older insertion/access)
//         let (key, value) = cache.pop_lru().unwrap();
//         assert_eq!(key, 4);  // Key 4 should be LRU, not key 1
...
//         assert_eq!(cache.len(), 4); // Over capacity, should evict
