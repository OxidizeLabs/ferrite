...
impl TestContext {
    ...
    fn create_employees_departments(&mut self) {
        ...
        let employees = tkdb::catalog::schema::Schema::new(vec![
            ...
            tkdb::catalog::column::Column::new("salary", tkdb::types_db::type_id::TypeId::Decimal),
            tkdb::catalog::column::Column::new("dept_id", tkdb::types_db::type_id::TypeId::Integer),
        ]);
        let departments = tkdb::catalog::schema::Schema::new(vec![
            tkdb::catalog::column::Column::new("dept_id", tkdb::types_db::type_id::TypeId::Integer),
            tkdb::catalog::column::Column::new("name", tkdb::types_db::type_id::TypeId::VarChar),
            tkdb::catalog::column::Column::new("budget", tkdb::types_db::type_id::TypeId::Decimal),
        ]);
